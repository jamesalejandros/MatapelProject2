<!DOCTYPE html> <html lang="id"> <head> <meta charset="UTF-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta name="theme-color" content="#111827">
<title>IT Asset Management</title>

<script src="https://cdn.tailwindcss.com"></script>

</head> <body class="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-amber-700 px-4 py-8 antialiased">
<div class="w-full max-w-3xl rounded-3xl border border-white/20 bg-white/95 p-6 shadow-2xl backdrop-blur-xl sm:p-10 md:p-12">
    ...
    <div class="mt-7 text-center">
        ...
        <p class="mx-auto mt-4 max-w-xl text-sm leading-6 text-gray-500 sm:text-base">
            ...
            layanan teknologi informasi, dan administrasi IT.
        </p>
    ...
    <div class="mt-10 grid gap-4 sm:grid-cols-2">
        ...
        <a
            href="{{ url('/login') }}"
            class="group rounded-2xl border border-blue-200 bg-blue-50 p-5 text-left transition duration-200 hover:-translate-y-1 hover:border-blue-300 hover:bg-blue-100 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
        ...
        <a
            href="{{ url('/admin') }}"
            class="group rounded-2xl border border-amber-200 bg-amber-50 p-5 text-left transition duration-200 hover:-translate-y-1 hover:border-amber-300 hover:bg-amber-100 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
        >
