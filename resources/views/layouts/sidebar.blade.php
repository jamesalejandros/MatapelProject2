...
Logika menu mengikuti navigation/navbar:
- Semua user:
* Permintaan IT
* Buat Request
- kepala_bagian:
...
<div x-data="{ sidebarOpen: false }" class="relative">
    ...
    <div x-show="sidebarOpen" x-cloak x-transition.opacity @click="sidebarOpen = false" class="
            fixed
            inset-0
            z-40
            bg-slate-900/40
    ...
    <aside :class="{
        ...
        <div class="
            ...
            <a href="{{ route('it-requests.index') }}" class="
                    flex
                    items-center
                    gap-3
                    transition-opacity
                ...
                <div class="
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 3h6m-7 4h8m-9 4h10m-9 4h8m-6 4h4" />
                    </svg>
    ...
    ?? auth()->user()->name }}
        ...
        <nav class="
            ...
            <div class="mb-6">
                ...
                <a href="{{ route('it-requests.index') }}" @click="sidebarOpen = false" class="
                        group
                        flex
                        items-center
                        gap-3
    ...
    : 'bg-slate-100 text-slate-500 group-hover:bg-white group-hover:text-slate-700'
                ...
                <a href="{{ route('it-requests.create') }}" @click="sidebarOpen = false" class="
                        group
                        mt-1
                        flex
                        items-center
    ...
    : 'bg-slate-100 text-slate-500 group-hover:bg-white group-hover:text-slate-700'
            ...
            @if (
                        ...
                        <div class="mb-6">
                            ...
                            <a href="{{ route('kepala-bagian.it-requests.index') }}" @click="sidebarOpen = false" class="
                    group
                    flex
                    items-center
                    gap-3
                ...
                ">
                    ...
                    ">
                                ...
                                NOTIFICATION BADGE
                                -----------------------------------------------------
                                Hanya muncul jika ada approval yang masih pending.
                                ====================================================== --}}
            ...
            @if (
                    ...
                    <div class="mb-6">
                        ...
                        <a href="{{ url('/admin') }}" @click="sidebarOpen = false" class="
                                    group
                                    flex
                                    items-center
                                    gap-3
        ...
        <div class="
            ...
            @if (Route::has('profile.edit'))
                ...
                <a href="{{ route('profile.edit') }}" @click="sidebarOpen = false" class="
                            group
                            flex
                            items-center
                            gap-3
