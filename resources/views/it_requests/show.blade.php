...
@php
    ...
    */
    ...
    $status = strtolower((string) ($itRequest->Status ?? 'pending'));
    ...
    $statusLabel = match ($status) {
        ...
        default => ucfirst((string) ($itRequest->Status ?? 'Pending')),
    };
    ...
    */
    ...
    | Controller:
    |
    | - hanya pemohon yang boleh konfirmasi
    | - hanya jika status selesai
    | - hanya jika belum pernah serah terima
    |
    */
    ...
    /*
    | Gunakan cast boolean agar aman terhadap nilai 1 / true.
    */
    $isSudahSerahTerima = (bool) $itRequest->SerahTerima;
...
@if (session('success'))
    ...
    <div class="mb-6 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800 shadow-sm">
...
@if (session('error'))
    ...
    <div class="mb-6 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 shadow-sm">
        <div class="flex items-start gap-3">
...
@if ($errors->any())
    ...
    <div class="mb-6 rounded-xl border border-red-200 bg-red-50 px-4 py-4 text-sm text-red-800 shadow-sm">
            ...
            @if ($canSerahTerima)
                ...
                <div class="mt-5 border-t border-amber-200 pt-5">
                    ...
                    <p class="text-sm font-medium text-amber-900">
                        Apakah Anda sudah menerima hasil penyelesaian permintaan ini?
                    </p>
    ...
    <div class="bg-gradient-to-r from-slate-900 to-slate-800 px-5 py-6 text-white sm:px-7">
        ...
        <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
                ...
                <span
                    class="mr-2 h-2 w-2 rounded-full {{ $statusClasses['dot'] }}"
                ></span>
        ...
        <div class="p-5 sm:p-6">
            ...
            <div class="mt-2 flex flex-wrap gap-2">
                ...
                @forelse ($itRequest->jenisPermintaan ?? [] as $jenis)
                    ...
                    >
                        {{ $jenis->name ?? $jenis->Nama ?? $jenis->JenisPermintaan ?? '-' }}
                    </span>
                ...
                @if ($approval)
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-1 font-medium text-slate-800">
                                {{ $approval->approver?->karyawan?->Nama
    ...
    <div class="space-y-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 px-5 py-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-violet-50 text-violet-600">
                        ...
                        >
                            ...
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                d="M19 10.5a7.5 7.5 0 01-11.91 6.08L4 18l1.42-3.09A7.5 7.5 0 1119 10.5z"
                            />
                        </svg>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-500">
                            Informasi atau catatan dari user yang terkait dengan request ini.
                        </p>
            ...
            <div class="p-5">
                ...
                @if ($canAddRelatedUserNote)
                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea
                                name="catatan"
                                id="related_user_catatan"
                                rows="4"
                                maxlength="5000"
                                required
                                placeholder="Tuliskan catatan atau informasi terkait request ini..."
                                class="block w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm leading-6 text-slate-800 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-violet-500 focus:ring-2 focus:ring-violet-200 @error('catatan') border-red-500 focus:border-red-500 focus:ring-red-200 @enderror"
                        ...
                        <button
                            type="submit"
                            class="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
                        >
                ...
                <div class="{{ $canAddRelatedUserNote ? 'mt-6 border-t border-slate-200 pt-5' : '' }}">
                    ...
                    <div class="mb-4 flex items-center justify-between">
                        ...
                        @if ($itRequest->relatedUserNotes?->count())

                            <span class="rounded-full bg-violet-50 px-2.5 py-1 text-xs font-semibold text-violet-700 ring-1 ring-inset ring-violet-200">
                                {{ $itRequest->relatedUserNotes->count() }}
                            </span>
                    ...
                    @empty
                        ...
                        <div class="rounded-xl bg-slate-50 px-4 py-5 text-center">
                            ...
                            <p class="mt-1 text-xs text-slate-400">
                                Catatan dari user terkait akan muncul di sini.
                            </p>
