    ...
    function initializeMultiSelect(config) {
        ...
        function filter() {
            ...
            options.forEach(option => {
                 ...
                 * LANGSUNG DIHILANGKAN DARI DROPDOWN
                 */
                if (selected.has(id)) {
                ...
                /*
                 * ITEM YANG BELUM DIPILIH
                 * FILTER BERDASARKAN SEARCH
                 */
                const matches = searchableText.includes(keyword);
                ...
                /*
                 * Checkmark tidak diperlukan lagi
                 * karena item yang dipilih sudah disembunyikan.
                 */
            ...
            /*
             * Tampilkan "tidak ditemukan" jika memang
        ...
        function select(id) {
            ...
            /*
             * Setelah dipilih, filter() akan langsung
             * menyembunyikan item tersebut dari dropdown.
             */
            searchInput.value = '';
        ...
        function deselect(id) {
            ...
            /*
             * Setelah dihapus dari tag,
             * item otomatis muncul kembali di dropdown.
             */
            filter();
        ...
        options.forEach(option => {
            ...
            option.addEventListener(
                ...
                function (event) {
                    ...
                    /*
                     * Karena item terpilih sudah disembunyikan,
                     * normalnya hanya item yang belum dipilih
                     * yang bisa diklik.
                     */
                    if (!selected.has(id)) {
        ...
        /*
         * Penting:
         * Jika ada old() dari validation error,
         * item yang sudah terpilih langsung disembunyikan.
         */
        filter();
