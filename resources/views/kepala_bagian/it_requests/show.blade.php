...
@section('title', 'Detail Permintaan IT — ' . $itRequest->NoRequest)
...
$approverNama =
    $itRequest->approval?->approver?->karyawan?->Nama
    ?? $itRequest->approval?->approver?->name
    ?? '-';

$approverInitial = strtoupper(
    substr(
        $approverNama,
        0,
        1
                ...
                <div class="border-b border-slate-100 px-5 py-4 sm:px-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600">
                            ...
                            {{ $itRequest->relatedUsers?->count() ?? 0 }}
                ...
                @else
                    ...
                    <div class="p-6 text-center">
                        ...
                        <p class="mt-1 text-xs leading-5 text-slate-500">
                            Approval untuk Kepala Bagian yang sedang login belum ditemukan.
                        </p>
