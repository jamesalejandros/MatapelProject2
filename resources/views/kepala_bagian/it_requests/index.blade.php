...
@section('title', 'Persetujuan Permintaan IT')
...
| Kepala Bagian dibedakan berdasarkan role "kepala_bagian".
|
*/
            ...
            <tbody class="divide-y divide-slate-100 bg-white">
                ...
                @foreach ($requests as $index => $itRequest)
                    ...
                    @php
                        ...
                        /*
                        |--------------------------------------------------------------------------
                        | APPROVAL KEPALA BAGIAN YANG LOGIN
                        |--------------------------------------------------------------------------
                        */
                        ...
                        if (
                            $approval instanceof \Illuminate\Database\Eloquent\Collection
                            || $approval instanceof \Illuminate\Support\Collection
                        ) {
                            $approval = $approval
                                ->firstWhere(
                                    'approver_id',
                        ...
                        */
                        ...
                        $pemohonNik =
                            $itRequest->pemohon?->karyawan?->NIK
                    ...
                    <tr class="transition hover:bg-slate-50">
                        ...
                        <td class="min-w-[200px] px-5 py-4 align-top">
                            ...
                            <a
                                href="{{ route(
                                    ...
                                    ['itRequest' => $itRequest->IDRequest]
                                ) }}"
                                class="font-semibold text-blue-600 hover:text-blue-800 hover:underline"
                            >

                                {{ $itRequest->NoRequest ?? 'Request #' . $itRequest->IDRequest }}
                        ...
                        <td class="min-w-[140px] px-5 py-4 align-top">
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-2 flex flex-wrap gap-1.5">
                        ...
                        @forelse ($itRequest->assets as $asset)
                            ...
                            <span class="rounded-md bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-700 ring-1 ring-inset ring-blue-200">
